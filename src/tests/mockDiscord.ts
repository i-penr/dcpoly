...
export default class MockDiscord {
	...
	private mockGuild(): void {
		this.guild = Reflect.construct(Guild, [
			this.client,
			{ unavailable: false, id: 'guildId', name: 'mocked guild' },
		]);
...
export async function mockInteractionAndSpyReply(
	command: string,
